...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	// Birisi authentica olmaya çalıştığında ne yapayım der.
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			LoginRequestModel credidentals = new ObjectMapper().readValue(request.getInputStream(),
	...
	// Authentication başarılı olduğunda ne yapayım der.
